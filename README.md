...
Это переносимая подсистема авторизации (Anonimous, Windows) для веб-приложений на Flask. Она спроектирована так, чтобы её можно было легко добавить в существующий проект.
